        ...
        <View style={styles.modalOverlay}>
          <View style={[styles.modalSheet, { maxHeight: "90%" }]}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
              ...
              {[
                {
                  title: "1. What Kiova Is",
                  body: "Kiova is a fashion styling platform that helps users organise their wardrobe, upload clothing items, and generate outfit ideas and style inspiration using technology, including AI-assisted features.\n\nKiova does not sell clothing directly and is not a general social or image-sharing platform.",
                },
                {
                  title: "2. Eligibility",
                  body: "To use Kiova, you must:\n• Be at least 13 years old (or the minimum legal age in your country)\n• Provide accurate account information\n• Have permission from a parent or guardian if required by law",
                },
                {
                ...
                },
                {
                  ...
                  body: 'Kiova is provided "as is" and "as available". We do not guarantee uninterrupted service or perfect AI results.\n\nAll styling recommendations are subjective and informational only.',
                },
                {
                ...
                },
                {
                  ...
                  body: 'We may update these Terms from time to time. The "Last updated" date will reflect the latest version.',
                },
                {
