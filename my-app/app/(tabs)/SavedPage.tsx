...
export default function SavedPage({ navigation }: any) {
      ...
      >
        ...
        <View style={styles.titleRow}>
          ...
          <View style={styles.titleButtons}>
            ...
            >
              <Feather name="shopping-bag" size={15} color="#1a1a1a" />
              <Text style={styles.outlineButtonText}>Wardrobe</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.blackButton} onPress={pickImage}>
              <Feather name="plus" size={15} color="white" />
              <Text style={styles.blackButtonText}>Save item</Text>
            </TouchableOpacity>
          </View>
        </View>

        <Text style={styles.subtitle}>
          Pieces you want to buy. Try them in outfits before you purchase.
        </Text>
        ...
        {filteredItems.length === 0 ? (
          <View style={styles.emptyState}>
            <View style={styles.emptyIconWrap}>
              <Feather name="bookmark" size={28} color="#bbb" />
            </View>
            ...
            <TouchableOpacity style={styles.emptyButton} onPress={pickImage}>
              ...
              <Text style={styles.emptyButtonText}>Save your first piece</Text>
            </TouchableOpacity>
          </View>
        ) : (
            ...
            {filteredItems.map((item) => (
              <View key={item.id} style={styles.card}>
                ...
                <View style={styles.cardTag}>
                  <Text style={styles.cardTagText}>{item.storeName}</Text>
                </View>
              </View>
            ))}
          </View>
